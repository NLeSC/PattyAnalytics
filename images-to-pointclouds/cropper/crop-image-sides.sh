...
exampleUsageStr="$0 --in 'data/SITES_image_based_base/SITE_9' --out 'data/SITES_image_based_cropped/SITE_9' --cropLeft 0.2 --cropRight 0.2 --cropTop 0.33 --cropBottom 0.0"
