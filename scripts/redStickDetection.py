...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Segment points by colour from a ply or pcd file and saves all reddish points into a pcd of ply file.')
    parser.add_argument('-i', '--inFile', required=True, type=str,
                        help='Input PLY/PCD file')
    parser.add_argument('-o', '--outFile', required=True, type=str,
                        help='Output PLY/PCD file')
